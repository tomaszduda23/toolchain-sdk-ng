...
unpack_remote(f"{BASE_URL}/v{VERSION}/zephyr-sdk-{VERSION}_linux-x86_64_minimal.tar.xz", ROOT_DIR)
unpack_remote(f"{BASE_URL}/v{VERSION}/toolchain_linux-x86_64_arm-zephyr-eabi.tar.xz", os.path.join(ROOT_DIR, f"zephyr-sdk-{VERSION}"))
